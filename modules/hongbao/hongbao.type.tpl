...
<div class="module_add">
	<div class="module_title"><strong>{if $magic.request.p=="type_edit"}修改{else}添加{/if}红包类型</strong></div>
<form action="{$_A.query_url_all}&p={$magic.request.p}" method="post">

	<div class="module_border">
		<div class="l">类型名称：</div>
		<div class="c">
			<input type="text" name="name"  class="input_border" value="{$_A.hongbao_type_result.name}"   size="20" />
		</div>
	</div>
	...
	<div class="module_border">
		<div class="l">标识名：</div>
		<div class="c">
			<input type="text" name="nid"  class="input_border" value="{$_A.hongbao_type_result.nid}"   size="20" />
		</div>
	</div>
	...
	<div class="module_border">
		<div class="l">状态：</div>
		<div class="c">
			<input type="radio" name="status"  class="input_border" value="1" {if $_A.hongbao_type_result.status==1} checked=""{/if}  />开启 
			<input type="radio" name="status"  class="input_border"  value="0" {if $_A.hongbao_type_result.status==0} checked=""{/if} />关闭
		</div>
	</div>
	...
	<div class="module_border">
		...
		<div class="c">
            <textarea name="desc">{$_A.hongbao_type_result.desc}</textarea>
		</div>
	</div>
...
{else}
<div class="module_add">
	<div class="module_title"><strong>红包类型</strong> <a href="{$_A.query_url_all}&p=type_new">【添加红包类型】</a></div>
</div>
<table  border="0"  cellspacing="1" bgcolor="#CCCCCC" width="100%">
	  <form action="" method="post">
		...
		{loop module="hongbao" function="GetTypeList" var="item" limit="all" }
