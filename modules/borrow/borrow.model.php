...
//还款
$MsgInfo["borrow_repay_borrow_nid_error"] = "您的操作有误。错误码【error:borrow_repay_borrow_nid_error】";
$MsgInfo["borrow_repay_userid_error"] = "您的操作有误。错误码【error:borrow_repay_userid_error】";
$MsgInfo["borrow_repay_id_error"] = "您的操作有误。错误码【error:borrow_repay_id_error】";
$MsgInfo["borrow_repay_error"] = "您的操作有误。错误码【error:borrow_repay_error】";
$MsgInfo["borrow_repay_yes"] = "您的操作有误。错误码【error:borrow_repay_yes】";
$MsgInfo["borrow_repay_status_error"] = "您的操作有误。错误码【error:borrow_repay_status_error】";
$MsgInfo["borrow_repay_borrow_error"] = "您的操作有误。错误码【error:borrow_repay_borrow_error】";
$MsgInfo["borrow_repay_step1_error"] = "您的操作有误。错误码【error:borrow_repay_step1_error】";
$MsgInfo["borrow_repay_step2_error"] = "您的操作有误。错误码【error:borrow_repay_step2_error】";
$MsgInfo["borrow_repay_step3_error"] = "您的操作有误。错误码【error:borrow_repay_step3_error】";
$MsgInfo["borrow_repay_up_notrepay"] = "您的上一期还未还款";
$MsgInfo["borrow_repay_advance_error"] = "此还款还未到期，如果想提前还款，请选择提前还款操作。";
$MsgInfo["borrow_repay_advance_not_error"] = "您的操作有误。错误码【error:borrow_repay_advance_not_error】";
$MsgInfo["borrow_repay_paypassword_error"] = "您的支付密码不正确";
$MsgInfo["borrow_repay_advance_repay_error"] = "您有到期或逾期的还款，不能进行提前还款";
$MsgInfo["borrow_repayfull_step1_error"] = "您的操作有误。错误码【error:borrow_repayfull_step1_error】";
$MsgInfo["borrow_repayfull_step2_error"] = "您的操作有误。错误码【error:borrow_repayfull_step2_error】";
$MsgInfo["borrow_repayfull_step3_error"] = "您的操作有误。错误码【error:borrow_repayfull_step3_error】";
$MsgInfo["borrow_repay_late_day_error"] = "您的操作有误。错误码【error:borrow_repay_late_day_error】";
$MsgInfo["borrow_repay_web_error"] = "不是逾期还款不能垫付";
$MsgInfo["borrow_repay_webstatus_error"] = "网站已垫付";
$MsgInfo["borrow_repay_advance_roam_error"] = "流转标不能提前还款";
$MsgInfo["borrow_part_not_account"] = "没有借款金额不能审核";



$MsgInfo["borrow_loan_account_min_error"] = "最小流转单位有误";
$MsgInfo["borrow_loan_account_min_account_error"] = "借款金额必须是最小流转单位的倍数";
$MsgInfo["borrow_loan_roam_voucher_empty"] = "担保机构不能为空";
$MsgInfo["borrow_loan_roam_vouch_style_empty"] = "反担保方式不能为空";
$MsgInfo["borrow_loan_roam_borrow_account_use_empty"] = "借款方资金用途不能为空";
$MsgInfo["borrow_loan_roam_risk_empty"] = "风险控制措施不能为空";
$MsgInfo["borrow_loan_account_min_account_max_error"] = "最小流转单位不能大于借款金额";
$MsgInfo["borrow_roam_paypassword_error"] = "支付密码不正确";
$MsgInfo["borrow_loan_roam_empty"] = "您的操作有误。错误码【error:borrow_loan_roam_empty】";
$MsgInfo["borrow_loan_roam_portion_error"] = "你购买的分数大于可购买的分数";
$MsgInfo["borrow_roam_account_use_none"] = "可用余额不足，请先充值";
