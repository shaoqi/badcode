...
define('__QQWRY__' , ROOT_PATH."data/qqwry/QQWry.Dat"); 
...
class QQWry{ 
    ...
    function qqwry ($dotip='') { 
        if(!$dotip)return; 
            if(ereg("^(127)",$dotip)){$this->Country="本地网络";$this->City="本局域网";return;} 
            elseif(ereg("^(192)",$dotip)) {$this->Country="本局域网";$this->City="本局域网";return;} 
