...
function magic_block_articles($tag_command,$parse_var,$magic_vars){
$var = "";
if  ($tag_command == "articles") {
$module = "";
$function = "";
$_data = "";
$user_id = "";
...
$display .= "  require_once(ROOT_PATH.'modules/{$module}/{$module}.{$plugins}.php');\$this->magic_vars['$var'] = {$module}{$plugins}Class::{$function}(\$data);";
}else{
